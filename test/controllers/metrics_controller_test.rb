...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post :create, metric: { corral_id: @metric.corral_id, description: @metric.description, metric_type: @metric.metric_type, name: @metric.name, weight: @metric.weight }
    end
  ...
  test "should update metric" do
    patch :update, id: @metric, metric: { corral_id: @metric.corral_id, description: @metric.description, metric_type: @metric.metric_type, name: @metric.name, weight: @metric.weight }
    assert_redirected_to metric_path(assigns(:metric))
  end
